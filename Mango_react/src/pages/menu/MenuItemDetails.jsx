   ...
   <div className="container py-4">
        ...
        <nav aria-label="breadcrumb" className="mb-4">
          <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item">
              <NavLink to = {ROUTES.MENU} className="text-decoration-none">
                Menu
              </NavLink> */}
            </li>
          ...
          <div className="col-lg-6">
            <div className="position-relative">
              <div className="rounded-4 overflow-hidden shadow-lg border bg-body position-relative">
                ...
                />
                {selectedMenuItem.specialTag &&  (<div className="position-absolute top-0 start-0 m-3">
              ...
              <div className="mb-4">
                <div className="d-flex align-items-start justify-content-between mb-3">
                  ...
                  <div className="text-end">
                    <div className="h2 text-primary fw-bold mb-0">${Number(selectedMenuItem.price || 0).toFixed(2)}</div>
                  </div>
                </div>
              </div>
                ...
                <div className="card border-0">
                  <div className="card-body p-4">
                    ...
                    <div className="mt-3 p-3  rounded border">
                      <div className="row">
                        <div className="col-6">
                          <small className="text-muted">Subtotal (${quantity} item{quantity==1?"":"s"})</small>
                        </div>
                ...
                <div className="row g-4 text-center">
                  ...
                  <div className="col-lg-3 col-md-6">
                    <div className="border-end border-light-subtle pe-3">
                      ...
                      <div className="text-primary fw-bold">${selectedMenuItem?.price.toFixed(2)}</div>
                    </div>
                  </div>
                  <div className="col-lg-3 col-md-6">
                    <i
