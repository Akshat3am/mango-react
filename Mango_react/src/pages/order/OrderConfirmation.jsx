...
function OrderConfirmation() {
  ...
  if(!orderData || Object.keys(orderData).length === 0){
    // If no order data, redirect to home or orders page
    navigate('/');
    return null;
  }
  return (
        ...
        <div className="col-md-6">
          ...
          <div className="card border shadow-sm">
            <div className="card-body p-4">
              ...
              <div className="mb-4">
                <strong>Number of Items:</strong> {orderData.totalItem}
              </div>
              <div className="mb-4">
                <strong>Order Total:</strong> ${orderData.orderTotal?.toFixed(2) || 0}
              </div>
              <div className="text-center">
                <button
                  className="btn btn-primary" onClick ={() => navigate(ROUTES.HOME)}
                >
                  Continue Shopping
                </button>
              </div>
