...
const filteredMenuItems = menuItems.filter((item) => {
  const matchesSearch = searchTerm ? item.name.toLowerCase().includes(searchTerm.toLowerCase()) || item.description.toLowerCase().includes(searchTerm.toLowerCase()) : true;
  ...
  return (
    <div className="container-fluid px-0">
      ...
      <div className="container" id="menu">
        ...
        {/* Loading State */}
        {isLoading &&  ( <div className="row row-cols-1 row-cols-sm-2 row-cols-lg-3 g-4 mb-5">
          <div className="col">
       ...
       {!isLoading && !error && (filteredMenuItems.length===0)?(<div className="text-center py-5">
          ...
          <div className="col">
            <div className="card h-100 border shadow-sm position-relative">
              <div className="position-relative overflow-hidden rounded-top">
                ...
                />
{item.specialTag &&  ( <div className="position-absolute top-0 end-0 m-3">
